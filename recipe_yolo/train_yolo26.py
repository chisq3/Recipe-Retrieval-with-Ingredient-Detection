"""Final YOLO26m training script for ingredient detection.

This recipe is the conservative YOLO26 final candidate:
- keeps the final YOLO11 augmentation philosophy
- uses only the minimum YOLO26-specific changes
- avoids the overly aggressive FT-A3hope recipe
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train final YOLO26m ingredient detector")
